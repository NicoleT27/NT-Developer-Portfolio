...
function Testimonial() {
  return (
    <div>
      ...
      <div className="quote">
      "Nicole and I have worked on three full-stack applications together. Among
      these were a travel itinerary, a Myspace-based application, and a game
      arcade. Of these three projects, it is the game arcade, Playful Pixels,
      that I believe best represent Nicole's work. Her dedication to top-notch
      presentation are indicative of her knowledge of the front-end creation of
      applications; her advice on my backend and her knowledge of NoSQL
      databases and models were invaluable while creating Playful Pixel's JWT
      user authentication. There is no doubt in my mind that Nicole is
      dedicated, inquisitive, and excited to learn. Anywhere she works, she will
      be an incredible asset with an eye for detail and perfectionism that will
      help her quickly deliver incredible full-stack projects."</div> 

       <div className="name">Alejandra Bernabel</div>
      <div className="from"> Software Engineer/Former UCF Bootcamp Colleague</div>
